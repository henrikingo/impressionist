    ...
    if( window.require ){
        var getDocumentElement = function (event, filename) {
            ...
            var script = impressionist().util.loadJavaScript(
                impressionistRoot + "/js/impressionist.js", function(){
...
(function ( document, window ) {
    ...
    var link = impressionist().util.loadCss(impressionistRoot + "/css/impressionist.css");
...
(function ( document, window ) {
    ...
    gc.addEventListener(document, "impressionist:init", function (event) {
        ...
        script = impressionist().util.loadJavaScript(impressionistRoot + "/node_modules/tinymce/tinymce.js", tinymceInit);
